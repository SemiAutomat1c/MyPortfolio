...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-40 pb-4 relative">
      <HeroBackground />
      <div className="container max-w-3xl mx-auto px-4">
        <motion.div
          ...
          className="border border-gray-200 dark:border-gray-800 rounded-lg p-6 bg-white/80 dark:bg-dark/80 backdrop-blur-sm mb-4 relative shadow-sm"
        >
